...
urlpatterns = [
    ...
    path('', landing_home, name='landing-home'),
    path('', include('allauth.urls')),
    path('register/', user_views.register, name='register'),
    path('profile/', user_views.profile, name='profile'),
    path('profile/(?P<pk>\d+)/', user_views.view_profile, name='view_profile_with_pk'),
    path('connect/(?P<operation>.+)/(?P<pk>\d+)/', user_views.update_friend, name='update_friend'),
